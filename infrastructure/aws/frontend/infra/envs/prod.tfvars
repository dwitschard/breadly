...
# envs/prod.tfvars
#
# Non-sensitive variable values for the `prod` Terraform workspace.
#
...
#
# Production deployments must be triggered manually via the GitHub Actions UI
# (workflow_dispatch → select "prod"). They are never deployed automatically.
#
# Apply manually:
...
# SPA routing: both index and error point to index.html.
