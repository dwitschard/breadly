...
const meta: Meta<BadgeComponent> = {
  ...
  argTypes: {
    ...
    count: {
      description:
        'Notification count. Displays "99+" for values above 99. Omit or pass null to hide the badge.',
      control: { type: 'number' },
      table: {
...
export const WithCount: Story = {
  render: () => ({
    template: `<app-badge [icon]="LucideBell" [count]="3" />`,
    props: { LucideBell },
  }),
};
export const HighCount: Story = {
  render: () => ({
    template: `<app-badge [icon]="LucideBell" [count]="150" />`,
    props: { LucideBell },
  }),
};
